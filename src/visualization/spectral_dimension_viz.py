...
THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §2.1, Eq. 2.8-2.9, Theorem 2.1
...
__version__ = "21.0.0"
__theoretical_foundation__ = "IRH v21.1 Manuscript Part 1 §2.1, Eq. 2.8-2.9, Theorem 2.1"
...
# Fixed point values (IRH v21.1 Manuscript Eq. 1.14)
...
def spectral_dimension(
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §2.1, Eq. 2.8-2.9
...
def graviton_correction(k: Union[float, np.ndarray], k_c: float = 1.0) -> Union[float, np.ndarray]:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §2.1.2
...
class SpectralDimensionAnimator:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §2.1, Theorem 2.1
    ...
    def plot_flow(
        ...
        ax.set_title('Spectral Dimension Flow (IRH v21.1 Manuscript Part 1 §2.1, Theorem 2.1)', fontsize=14)
    ...
    def plot_vs_t(
        ...
        ax.set_title('Spectral Dimension vs RG Time (IRH v21.1 Manuscript Eq. 2.8-2.9)', fontsize=14)
        ax.grid(True, alpha=0.3)
        ax.set_ylim(1.5, 4.5)
    ...
    def plot_graviton_contribution(
        ...
        ax.set_title('Graviton Contribution to Spectral Dimension (IRH v21.1 Manuscript Part 1 §2.1.2)', fontsize=14)
        ax.legend()
        ax.grid(True, alpha=0.3)
...
def create_interactive_spectral_plot(
    ...
    fig.update_layout(
        title='Interactive Spectral Dimension Flow (IRH v21.1 Manuscript Part 1 §2.1)',
