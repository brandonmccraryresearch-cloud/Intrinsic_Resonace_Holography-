...
THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §2.4, Eq. 2.24-2.26, Appendix J.1
...
class LIVParameter:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §2.4.1, Eq. 2.24'
        }
...
class ModifiedDispersion:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §2.4.2, Eq. 2.25'
        }
...
class GenerationLIV:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 2 Appendix J.1
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 2 Appendix J.1'
        }
...
def compute_generation_liv(fermion_type: str) -> GenerationLIV:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 2 Appendix J.1, Eq. J.1
...
class PhotonDispersion:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §2.4.3, Eq. 2.26
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §2.4.3, Eq. 2.26'
        }
...
class GammaRayTest:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 2 §8.3
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 2 §8.3'
        }
...
def verify_liv_predictions() -> Dict:
    ...
    return {
        ...
        'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §2.4'
    }
