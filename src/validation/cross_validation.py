...
"""
THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 2 Appendix A.5, Eq. 1.12
...
Theoretical References:
    IRH v21.1 Manuscript Appendix A.5: Convergence to continuum limit
    IRH v21.1 Manuscript Eq. 1.12: Wetterich equation (exact differential equation)
    IRH v21.1 Manuscript Appendix A.4: QUCC-Theorem (compressor independence)
"""
...
class ConvergenceAnalysis:
    ...
    def rg_step_size_convergence(
        ...
        result = ConvergenceResult(
            ...
            relative_error=rel_error,
            status=status,
            theoretical_reference="IRH v21.1 Manuscript Eq. 1.12 (Wetterich equation)"
        )
...
class AlgorithmicCrossValidation:
    ...
    def fixed_point_solvers_agreement(self) -> List[CrossValidationResult]:
        ...
        for key, name in zip(coupling_names, display_names):
            ...
            result = CrossValidationResult(
                ...
                status=status,
                threshold=1e-8,
                theoretical_reference="IRH v21.1 Manuscript Eqs. 1.13-1.14"
            )
    ...
    def _solve_beta_zero(self) -> Dict[str, float]:
        ...
        in IRH v21.1 Manuscript, which includes non-perturbative effects beyond
    ...
    def laplacian_methods_agreement(
        ...
        result = CrossValidationResult(
            ...
            status=status,
            threshold=1e-3,
            theoretical_reference="IRH v21.1 Manuscript Part 1 §1.1, Eq. 1.1"
        )
    ...
    def beta_function_methods_agreement(self) -> List[CrossValidationResult]:
        ...
        for name in beta_names:
            ...
            result = CrossValidationResult(
                ...
                status=status,
                threshold=1e-6,
                theoretical_reference="IRH v21.1 Manuscript Eq. 1.13"
            )
