...
THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §3.2.4, Appendix E.3
...
__version__ = "21.0.0"
__theoretical_foundation__ = "IRH v21.1 Manuscript Part 1 §3.2.4, Appendix E.3"
...
class NeutrinoMasses:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §3.2.4, Appendix E.3
    ...
    def verify_mass_splittings(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §3.2.4',
        }
