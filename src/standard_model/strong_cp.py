...
THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §3.4, Appendix E.4
...
__version__ = "21.0.0"
__theoretical_foundation__ = "IRH v21.1 Manuscript Part 1 §3.4, Appendix E.4"
...
class StrongCPResolution:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §3.4.1
    ...
    def verify_theta_zero(self) -> Dict:
        ...
        return {
            ...
            'no_fine_tuning': True,
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §3.4.1',
        }
    ...
    def peccei_quinn_symmetry(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §3.4.2',
        }
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §3.4',
        }
...
class AlgorithmicAxion:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §3.4.2, Appendix E.4
    ...
    def dark_matter_density(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §3.4.3',
        }
    ...
    def experimental_detection(self) -> Dict:
        ...
        return {
            ...
            'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §3.4.4',
        }
