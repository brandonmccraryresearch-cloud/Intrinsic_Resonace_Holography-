...
THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §3.1.2, Appendix D.2-D.3
...
class VortexWavePattern:
    ...
    def _compute_mass(self) -> float:
        ...
        THEORETICAL FOUNDATION: IRH v21.1 Manuscript Eq. 3.6
        """
...
def compute_vwp_mass(vwp: VortexWavePattern) -> Dict:
    ...
    return {
        ...
        'theoretical_reference': 'IRH v21.1 Manuscript Eq. 3.6'
    }
...
def topological_complexity_operator() -> ComplexityOperator:
    ...
    THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 2 Appendix D.3
...
def vwp_overlap_integral(vwp1: VortexWavePattern, vwp2: VortexWavePattern) -> float:
    ...
    THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 2 Appendix D.3, Eq. D.7
...
def verify_vwp_stability() -> Dict:
    ...
    return {
        ...
        'theoretical_reference': 'IRH v21.1 Manuscript Part 2 Appendix D.2'
    }
