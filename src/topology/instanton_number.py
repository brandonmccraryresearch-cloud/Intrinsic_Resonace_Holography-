...
THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §3.1.2, Appendix D.2
...
# ============================================================================
# Physical Constants (IRH v21.1 Manuscript Part 1 §3.1.2)
# ============================================================================
...
class InstantonResult:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 1 §3.1.2, Appendix D.2
    """
    n_inst: int
    ...
    generations: int
    is_verified: bool
    theoretical_reference: str = "IRH v21.1 Manuscript Part 1 §3.1.2, Appendix D.2"
...
class TopologicalCharge:
    ...
    Theoretical Reference:
        IRH v21.1 Manuscript Part 2 Appendix D.2
    """
    charge: int
    winding_number: int
    generation: int
...
def compute_instanton_number(
    ...
    References
    ----------
    .. [1] IRH v21.1 Manuscript Part 1 §3.1.2 - Three Fermion Generations
    .. [2] IRH v21.1 Manuscript Part 2 Appendix D.2 - Proof of n_inst = 3
    """
    if verbose:
...
def verify_three_generations(tolerance: float = 0) -> Dict:
    ...
    THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 2 Appendix D.2
    ...
    return {
        ...
        'theoretical_reference': 'IRH v21.1 Manuscript Part 2 Appendix D.2, Theorem D.2'
    }
...
def get_fermion_generations() -> List[FermionGeneration]:
    ...
    THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §3.1.2
...
def topological_complexity(generation: int) -> float:
    ...
    THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 2 Appendix D.3, Eq. 3.6
...
def compute_mass_hierarchy_ratios() -> Dict:
    ...
    THEORETICAL FOUNDATION: IRH v21.1 Manuscript Part 1 §3.2.3, Appendix D.3
    ...
    return {
        ...
        'theoretical_reference': 'IRH v21.1 Manuscript Part 1 §3.2.3, Eq. 3.6'
    }
